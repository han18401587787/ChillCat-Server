...
type EmotionCheckin struct {
	...
	AudioStatus string    `json:"audio_status" gorm:"size:20;default:''"` // pending/transcribing/analyzed/failed
...
// TableName 表名
func (EmotionCheckin) TableName() string {
	return "emotion_checkins"
}
